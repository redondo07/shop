...
<div class="container" id="idTransformView">
  ...
  <?php $_from = $this->_var['flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'flash_0_41764100_1435819252');$this->_foreach['myflash'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['myflash']['total'] > 0):
    foreach ($_from AS $this->_var['flash_0_41764100_1435819252']):
        $this->_foreach['myflash']['iteration']++;
?>
      <li style="background:url(<?php echo $this->_var['flash_0_41764100_1435819252']['src']; ?>) center 0 no-repeat; position:relative;"><a href="<?php echo $this->_var['flash_0_41764100_1435819252']['url']; ?>" target="_blank"></a></li>
  ...
  <ul class="num" id="idNum">
     ...
     <?php $_from = $this->_var['flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'flash_0_41772800_1435819252');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['flash_0_41772800_1435819252']):
